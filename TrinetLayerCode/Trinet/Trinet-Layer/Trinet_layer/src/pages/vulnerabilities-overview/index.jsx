...
const VulnerabilitiesOverview = () => {
  ...
  const vulnerabilities = [
    ...
    },
    {
      ...
      severity: "Critical",
      complexity: "High",
      descriptionSimple: "RCE vulnerabilities enable attackers to execute arbitrary code on the target system, potentially gaining complete control over the affected server or application.",
      descriptionAdvanced: "Remote Code Execution exploits allow arbitrary command execution on target systems through deserialization flaws, command injection, or unsafe file operations.",
      payloadCount: 289,
      targetCount: 98,
      trend: "+22% this month",
      detailPath: "/vulnerabilities-overview",
    ...
    },
    {
      ...
      severity: "High",
      complexity: "Medium",
      descriptionSimple: "XXE attacks exploit vulnerable XML processors to access local files, perform server-side request forgery, or cause denial of service through entity expansion.",
      descriptionAdvanced: "XXE vulnerabilities leverage misconfigured XML parsers to process external entities, enabling file disclosure, SSRF, and denial of service attacks.",
      payloadCount: 167,
      targetCount: 73,
      trend: "+7% this month",
      detailPath: "/vulnerabilities-overview",
